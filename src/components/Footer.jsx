...
function Footer() {
  const { piePagina } = useContext(MainContext)
  return (
    <>
      <footer className="bg-blue-800 dark:text-gray-50 mt-5">
          ...
          <div className="flex flex-col justify-center pt-6 lg:pt-0">
            <div className="flex justify-center space-x-4">
              <a
                ...
                href="#"
                title="Instagram"
                className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-red-700  dark:text-white transform transition duration-500 hover:scale-110"
              >
                <svg
